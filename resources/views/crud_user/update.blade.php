            ...
            <form action="{{ route('user.postUpdateUser') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" value="{{ $user->email }}" required class="w-full pl-10 pr-4 py-2.5 bg-slate-950 border border-slate-800/80 rounded-xl text-slate-200 text-sm focus:border-indigo-500 focus:outline-none transition-all" placeholder="admin@example.com">
                    </div>
                </div>
